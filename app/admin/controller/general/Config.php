...
class Config extends Backend
{
    ...
    public function index()
    {
        ...
        foreach ($this->model->select()->append(['extend_html']) as $k => $v) {
    ...
    public function check()
    {
        ...
        if ($params) {
            $config = $this->model->where($params)->find();
            if (!$config) {
                $this->success();
            } else {
    ...
    public function selectpage()
    {
        ...
        $this->model = Db::connect()->setTable($setting['table']);
    ...
    public function get_fields_list()
    {
        ...
        $default = \think\facade\Config::get('database.default');
        $dbname = \think\facade\Config::get('database.connections.' . $default);
        //从数据库中获取表字段信息
